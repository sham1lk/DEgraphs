...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/myChart.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/Abstrct_method.js":
/*!*******************************!*\
  !*** ./src/Abstrct_method.js ***!
  \*******************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _RK_method_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RK_method.js */ \"./src/RK_method.js\");\n/* harmony import */ var _Euler_method_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Euler_method.js */ \"./src/Euler_method.js\");\n/* harmony import */ var _Exact_method_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Exact_method.js */ \"./src/Exact_method.js\");\n/* harmony import */ var _Imp_Euler_method_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Imp_Euler_method.js */ \"./src/Imp_Euler_method.js\");\n/* harmony import */ var _Chart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Chart.js */ \"./src/Chart.js\");\n\n\n\n\n\n\n\"use strict\";\n\n\n\n\n$(\"#renderBtn\").click(\n\n    function() {\n        let myChart = new _Chart_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\"Solutions\",\"myChart\",\"mcontainer\");\n        let myChart1 = new _Chart_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\"Global errors\",\"myChart1\",\"mcontainer1\");\n        let myChart2 = new _Chart_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\"Local errors\",\"myChart2\",\"mcontainer2\");\n        myChart.createChart();\n        myChart1.createChart();\n        myChart2.createChart();\n        let x0 = document.getElementById(\"txt1\").value;\n        let y0 = document.getElementById(\"txt2\").value;\n        let x = document.getElementById(\"txt3\").value;\n        let h = document.getElementById(\"txt4\").value;\n        let N0 = document.getElementById(\"txt5\").value;\n        let e_method = new _Euler_method_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](x0,y0,x,h);\n        let i_e_method = new _Imp_Euler_method_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](x0,y0,x,h);\n        let rk_method = new _RK_method_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](x0,y0,x,h);\n\n        if (document.getElementById(\"checkboxTwo\").checked == true) {\n            i_e_method.draw(myChart.chart);\n            i_e_method.local_err(myChart2.chart, \"IEM localerr\", \"#fcdacd\");\n            i_e_method.global_err(myChart1.chart,N0);\n        }\n        if (document.getElementById(\"checkboxOne\").checked == true) {\n            e_method.draw(myChart.chart);\n            e_method.local_err(myChart2.chart, \"E local err\", \"#dc5a7f\");\n            e_method.global_err(myChart1.chart,N0);\n\n        }\n\n        if (document.getElementById(\"checkboxThree\").checked == true) {\n            rk_method.draw(myChart.chart);\n            rk_method.local_err(myChart2.chart, \"RK local err\", \"#fba422\");\n            rk_method.global_err(myChart1.chart,N0);\n\n        }\n        let exact_method = new _Exact_method_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](x0, y0, x, h);\n        exact_method.draw(myChart.chart);\n\n    }\n);\n\n//# sourceURL=webpack:///./src/myChart.js?");
